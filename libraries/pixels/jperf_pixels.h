...
#define JPERF_BOUNDARY_WRIST_FOREARM (0 + JPERF_PIXELS_WRIST)
#define JPERF_BOUNDARY_FOREARM_ELBOW (JPERF_BOUNDARY_WRIST_FOREARM + JPERF_PIXELS_FOREARM)
#define JPERF_BOUNDARY_ELBOW_BICEP (JPERF_BOUNDARY_FOREARM_ELBOW + JPERF_PIXELS_ELBOW)
#define JPERF_BOUNDARY_BICEP_NECK (JPERF_BOUNDARY_ELBOW_BICEP + JPERF_PIXELS_BICEP)

#define JPERF_BOUNDARY_NECK_LBICEP (JPERF_BOUNDARY_BICEP_NECK + JPERF_PIXELS_NECK)

#define JPERF_BOUNDARY_LBICEP_LELBOW (JPERF_BOUNDARY_NECK_LBICEP + JPERF_PIXELS_BICEP )
